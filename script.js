/* $( "#conteudoBotaoExpadir1" ).on( "click", function() {
    document.getElementsById('conteudoRespostaPergunta1').classList.add('displayNone');
}); */
...
function botaoExpandirRecolherPergunta1(){
    ...
    if(document.getElementById('botaoExpadirRecolherPergunta1').getAttribute("name") == "expandir"){
        document.getElementById('conteudoRespostaPergunta1').classList.remove('displayNone');
        ...
        document.getElementById('conteudoRespostaPergunta1').classList.add('displayNone');
...
function botaoExpandirRecolherPergunta2(){
    ...
    if(document.getElementById('botaoExpadirRecolherPergunta2').getAttribute("name") == "expandir"){
        document.getElementById('conteudoRespostaPergunta2').classList.remove('displayNone');
        ...
        document.getElementById('conteudoRespostaPergunta2').classList.add('displayNone');
...
function botaoExpandirRecolherPergunta3(){
    ...
    if(document.getElementById('botaoExpadirRecolherPergunta3').getAttribute("name") == "expandir"){
        document.getElementById('conteudoRespostaPergunta3').classList.remove('displayNone');
        ...
        document.getElementById('conteudoRespostaPergunta3').classList.add('displayNone');
...
function botaoExpandirRecolherPergunta4(){
    ...
    if(document.getElementById('botaoExpadirRecolherPergunta4').getAttribute("name") == "expandir"){
        document.getElementById('conteudoRespostaPergunta4').classList.remove('displayNone');
        ...
        document.getElementById('conteudoRespostaPergunta4').classList.add('displayNone');
...
function botaoExpandirRecolherPergunta5(){
    ...
    if(document.getElementById('botaoExpadirRecolherPergunta5').getAttribute("name") == "expandir"){
        document.getElementById('conteudoRespostaPergunta5').classList.remove('displayNone');
        ...
        document.getElementById('conteudoRespostaPergunta5').classList.add('displayNone');
...
function botaoExpandirRecolherPergunta6(){
    ...
    if(document.getElementById('botaoExpadirRecolherPergunta6').getAttribute("name") == "expandir"){
        document.getElementById('conteudoRespostaPergunta6').classList.remove('displayNone');
        ...
        document.getElementById('conteudoRespostaPergunta6').classList.add('displayNone');
